...
//
$prefix = 'mythemeoptions';

//
// Create options
//
CSF::createOptions( $prefix, array(
  'menu_title' => 'WPlearn Theme Options',
  'menu_slug'  => 'csf-demo',
) );
...
CSF::createSection( $prefix, array(
  ...
  'icon'        => 'far fa-square',
  'description' => 'developershaif.com',
  'fields'      => array(
...
CSF::createSection( $prefix, array(
  ...
  'title'       => 'About Us',
  'icon'        => 'far fa-square',
  'description' => 'mohammad shaifuddin: <a href="http://developershaif.com" target="_blank">Developershaifu.com</a>',
  'fields'      => array(
    ...
    array(
      'id'          => 'second-des',
      'type'        => 'textarea',
      'title'       => 'Second Descirption',
      'default'     => 'there are second description'
    ),
    array(
      'id'      => 'about-video',
      'type'    => 'text',
      'title'   => 'paste Your vedio url',
    ),
    array(
      'id'     => 'about-feature',
      'type'   => 'repeater',
      'title'  => 'Feature of About',
      'fields' => array(
        array(
          'id'    => 'featureoption',
          'type'  => 'text',
    ...
    array(
      'id'     => 'about-feature2',
      'type'   => 'repeater',
      'title'  => 'Another Feature of About',
      'fields' => array(
        array(
          'id'    => 'featureoption2',
          'type'  => 'text',
