<?php get_header(); ?>
						...
						<div class="row">
							<div class="col-12">
								<div class="single-main">
									...
									<div class="meta">
										<div class="meta-left">
											<span class="author"><a href="#"> <?php echo get_avatar(get_the_author_meta("ID"),1) ?></a></span>
											...
											<div class="row">
												<div class="col-lg-6 col-md-6 col-12">
													<div class="single-image">
														<?php the_post_thumbnail('post-thumbnail', ['class' => 'shaifu responsive_img', 'title' =>'image name']); ?>
													</div>
												</div>
												<div class="col-lg-6 col-md-6 col-12">
													<div class="single-image">
							...
							<div class="single-widget category">
								...
								<ul class="categor-list">
									...
									foreach($category_list as $single_category){
										?>
										<li><a href="<?php echo esc_url(get_category_link($single_category->term_id)); ?>"><?php echo esc_html($single_category->name );?></a></li>
										<?php
									}
									?>
		...
		_e('there are something missing');
		endif;
