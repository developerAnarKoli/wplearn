					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-12">
							<div class="copyright-content">
								<p>
									<?php 
									$footer_copy = get_option('mythemeoptions');
									if(isset($footer_copy['copyrights'])){
										echo $footer_copy['copyrights'];
									}else{
										echo "there no copy right text";
									}
									 ?>
								</p>
							</div>
		...
		<!-- jequery for sub menus code start  -->
		...
		<!-- jequery for sub menus code end  -->
